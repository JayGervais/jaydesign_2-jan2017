...
<html lang="en">
  <head>
    ...
    <title>Jay Gervais Design - Contact</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://jaygervaisdesign.com">Jay Gervais</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://jaygervaisdesign.com">Home</a></li>
            ...
            <li><a href="http://jaygervaisdesign.com/contact.html">Contact</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
<section id="contact">
  <div class="contact">
    ...
    <hr>
<div id="form">
<p style="float:right;"><a href="https://www.linkedin.com/in/jaygervais" target="_blank" style="color:black;"><i class="fa fa-linkedin-square" style="font-size:36px"></a></i></p>
<h2>Jay Gervais</h2>
<em><p>Located in Red Deer, Alberta</p></em>
<hr>
<br />
<p>Use this form to get in touch with me. I'd love to hear from you.</p>

<form method="post" action="contacttemplate.php">
...
<!-- end PHP code -->
                ...
                <p>No information will be shared.</p>
              </div>
